...
Citation
Kantner, J., & Lindsay, D. S. (2012). Response bias in recognition memory as a cognitive trait. Memory & Cognition, 40(8), 1163-1177. Data come from Experiment 1.
...
Manipulations
There were no manipulations in the experiment.

Block size
There were two study-test cycles; a 10-minute filler task separated the two cycles. Each cycle contained 48 study items and 96 test items.
...
Experiment goal
Determine whether response bias on the first test predicted response bias on the second test. 

Main result
There was a strong positive correlation between bias on the two tests.
