...
Citation
Kantner, J., & Lindsay, D. S. (2012). Response bias in recognition memory as a cognitive trait. Memory & Cognition, 40(8), 1163-1177. Data come from Experiment 4.
...
Block size
There was one study-test cycle with 48 study items and 96 test items.
...
Experiment goal
Determine whether response bias on a recognition test predicted risk-taking on a trivia task and false recall of critical lures on a DRM task (Roediger & McDermott, 1995).

Main result
Recognition response bias was significantly negatively correlated with false recall of critical DRM lures but had no apparent relationship with risk-taking on the trivia task.
