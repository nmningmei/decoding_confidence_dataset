...
Citation: 
preprint on bioRxiv https://www.biorxiv.org/content/10.1101/561548v1. This is the dataset for the experiment with the small angle (experiment 2 in the preprint).

Stimulus: 
Stimuli were random dot motion stimuli (black and white dots). They moved in one of two directions (+/- 5 deg from vertical upwards) on the average (in column 'Stimulus', 1 = left from vertical, 2 = right from vertical). However, each dot had a random deviation from this direction taken from a Gaussian distribution with a standard deviation of [0 2.1970 3.7129 6.2748 10.6045 17.921 30.2875 51.1859] deg. Response is coded a 1=left from vertical, 2 = right from vertical. 
...
Manipulations: 
- overall motion direction (in column 'Stimulus', 265 = left from vertical, 275 = right from vertical)
- noisiness of motion, each dot had a random deviation from this direction taken from a Gaussian distribution with a standard deviation of [0 2.1970 3.7129 6.2748 10.6045 17.921 30.2875 51.1859] deg
...
Subject population: 
37 participants, mostly student population. Ranging from 18-33 years old (M = 24.46, SD = 5.14). Age, sex, and AQ score of the participant are provided in the columns Age, Sex (0=Male, 1=Female), AQ, respectively.
...
Special instructions: subjects encouraged to use the whole confidence scale

Link to material/codes: not available yet.

Experiment dates: data was collected between Oct 2017 and March 2018.
